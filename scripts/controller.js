(function ($) {
    $.widget("pic.controller", {
        ...
        _initController: function(data) {
            var self = this, o = self.options, el = self.element;
            el.empty();
            let div = $('<div class="picControllerTitle picControllerTime"><span class="picControllerTime" /></div>');
            div.appendTo(el);
        ...
        setConnectionError: function (data) {
            var self = this, o = self.options, el = self.element;
            el.find('div.picControllerTime > span.picControllerTime').each(function () {
                $(this).text('--/--/---- --:--');
            });
